void disp_CPUID_leaf2(uint32_t val){
   switch(val){
      ...
      case 0x0B: printf( " 0CH   1st-level data cache  16 KBytes, 4-way set associative, 32 byte line size\n");break;
      ...
      case 0xF0: printf( " Prefetch F1H Prefetch 128-Byte prefetching\n");break;
