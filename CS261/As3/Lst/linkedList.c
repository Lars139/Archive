...
void _addLinkBefore(struct linkedList *lst, struct DLink *l, TYPE v)
{
	...
	temp->next = l;        //set the new link to point to l
        temp->prev = l->prev;  //set the previous of new link to points to what l was pointing to  
	l->prev->next = temp;  //set the link before l to points to the temp.
      	l->prev = temp;        //set the previous l to point to temp 
	temp->value = v;
